...
vx = st.number_input('📳 ค่าการสั่นสะเทือนตามแนวแกน X', value=0.0)

vy = st.number_input('📳 ค่าการสั่นสะเทือนตามแนวแกน Y', value=0.0)

vz = st.number_input('📳 ค่าการสั่นสะเทือนตามแนวแกน Z', value=0.0)
