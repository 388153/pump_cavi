...
with col1:
    vx = st.number_input('📳 ค่าการสั่นตามแนวแกน X $(m/s^2)$', value=0.0)
with col2:
    vy = st.number_input('📳 ค่าการสั่นตามแนวแกน Y $(m/s^2)$', value=0.0)
with col3:
    vz = st.number_input('📳 ค่าการสั่นตามแนวแกน Z $(m/s^2)$', value=0.0)
